    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
        <div className="text-center">
          ...
          <h3 className="text-gray-600 font-medium mb-1">Apple Music 로그인 필요</h3>
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
        <div className="text-center">
          ...
          <h3 className="text-gray-600 font-medium mb-1">음악 목록이 없습니다</h3>
          <p className="text-gray-500 text-sm">
        ...
        {lastCreationResult.success ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-green-700 space-y-1">
                  <p className="font-medium">"{lastCreationResult.playlistName}"</p>
                  <p className="text-sm">
            ...
            <div className="mt-4 flex space-x-3">
              ...
              <button
                ...
                className="bg-white hover:bg-gray-50 text-green-700 border border-green-300 px-4 py-2 rounded-lg text-sm font-medium transition-colors"
              >
                Apple Music에서 확인
              </button>
            </div>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-red-800 font-medium">플레이리스트 생성 실패</h3>
        ...
        <div className="text-center">
          ...
          <div className="text-blue-700 space-y-2">
            ...
            {creationProgress.currentTrack && (
              <p className="text-xs truncate max-w-md mx-auto">
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <h4 className="font-medium text-gray-900 mb-2">📋 추가될 곡 목록</h4>
        ...
        <div className="flex space-x-3 pt-2">
          <button
            ...
            className="flex-1 bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
